...
| JCE_INTEGER_LITERAL JCE_REQUIRE type_id JCE_STRING_LITERAL
{
    StructPtr np = StructPtr::dynamicCast(g_parse->currentContainer());
    if(np)
    {
...
| JCE_INTEGER_LITERAL JCE_REQUIRE type_id '=' const_initializer JCE_STRING_LITERAL
{
    StructPtr np = StructPtr::dynamicCast(g_parse->currentContainer());
    if(np)
    {
...
| JCE_INTEGER_LITERAL JCE_OPTIONAL type_id '=' const_initializer JCE_STRING_LITERAL
{
    StructPtr np = StructPtr::dynamicCast(g_parse->currentContainer());
    if(np)
    {
...
| JCE_INTEGER_LITERAL JCE_OPTIONAL type_id JCE_STRING_LITERAL
{
    StructPtr np = StructPtr::dynamicCast(g_parse->currentContainer());
    if(np)
    {
